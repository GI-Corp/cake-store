...
public class IdentityExceptionHandlerMiddleware : BaseErrorHandlerMiddleware<IdentityExceptionHandlerMiddleware>
{
private readonly IErrorService _errorService;
private readonly IReferenceContainer _referenceContainer;

public IdentityExceptionHandlerMiddleware(
    IEventLoggerService<IdentityExceptionHandlerMiddleware> logger,
